...
%
%  function [x,k] = newtons(f,x,tol,mmax)
%
% This function returns in  x acolumn vector x_k such that 
...
% 
% The iterates ||f(x_k)|| are recorded. This option can be easily turned off.
